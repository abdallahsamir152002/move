  ...
  return (
    <div className="w-full h-screen relative overflow-x-hidden">
      ...
      <div className=" pt-24 h-full">
        <div className="absolute top-0 right-0 w-full h-full bg-lime-500/40 backdrop-blur-sm hero-section-clip-path left-side"></div>
        <div className="absolute top-0 right-0 w-full h-full bg-lime-500/40 backdrop-blur-sm hidden md:block hero-section-clip-path right-side"></div>
        <motion.div
          className="absolute top-1/3 transform left-8 md:left-24 -translate-y-1/2 z-20 pt-24 pr-8 lg:max-w-1/3 w-full"
          initial={{ opacity: 0, transform: "translateX(-200px)" }}
          animate={{ opacity: 1, transform: "translateX(0px)" }}
          transition={{ duration: 0.5, delay: 1 }}
        >
          <h1 className="text-white text-4xl font-bold">Move Sharing</h1>
          <p className="text-gray-600 mt-4 max-w-[90%]">
          ...
          <div className="mt-8 flex flex-col w-fit gap-4 md:flex-row ">
            <motion.button
        ...
        <motion.img
          ...
          className="w-2xl object-contain absolute top-1/2 -right-24 -translate-y-1/3 z-10 hidden md:block"
          initial={{ opacity: 0, transform: "translateX(200px)" }}
          animate={{ opacity: 1, transform: "translateX(0px)" }}
          transition={{ duration: 0.5, delay: 1 }}
        />
